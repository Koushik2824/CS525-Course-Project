    ...
    for i in range(n):
        for j in range(n):
        	...
        	if (i == 0 and j == 0) or (i == n-1 and j == n-1):
        		continue
        	if j < n - 1 and (i!=n-1 or j!=n-2):  # Horizontal dominoes
        		var_map[(i, j, 'h')] = var_count
        		var_count += 1
        	if i < n - 1 and (i!=n-2 or j!=n-1):  # Vertical dominoes
...
with open("full_board_3.cnf", "w") as f:
    f.write(cnf_output)

print("CNF file 'full_board_3.cnf' generated successfully.")
